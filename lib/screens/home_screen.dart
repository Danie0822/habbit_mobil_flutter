...
class _HomeScreenState extends State<HomeScreenOne> {
  ...
  void initState() {
    ...
    // Cargar las propiedades más recientes
    recentPropertiesFuture = PropertiesService().getPropertiesRecently();
    // Cargar las propiedades más deseadas
    popularPropertiesFuture = PropertiesService().getPropertiesPopular();
  }
