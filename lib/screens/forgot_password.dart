...
import 'package:go_router/go_router.dart'; // Importa el paquete GoRouter para la navegación.
...
class _ForgotViewState extends State<ForgotView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.transparent, // Fondo transparente para la barra de la aplicación
        elevation: 0, 
        leading: IconButton(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: horizontalPadding), // Padding horizontal para el contenido
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: MyTextField( //Input de correo
                  context: context, 
                  hint: "Email", 
                  isPassword: false, 
              ...
              CustomButton(// Boton
                onPressed: () {
                  context.push('/code'); // Navega a la pantalla '/code' al hacer clic en el botón
                },
                text: "Enviar código", 
              ),
            ],
